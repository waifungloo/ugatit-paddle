...
def train(args):
    ...
    input_A = fluid.layers.data(
        name='input_A', shape=data_shape, append_batch_size=True, dtype='float32')
    input_B = fluid.layers.data(
        name='input_B', shape=data_shape, append_batch_size=True, dtype='float32')
    fake_pool_A = fluid.layers.data(
        name='fake_pool_A', shape=data_shape, append_batch_size=True, dtype='float32')
    fake_pool_B = fluid.layers.data(
        name='fake_pool_B', shape=data_shape, append_batch_size=True, dtype='float32')
