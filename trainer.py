...
from model import build_generator_resnet_blocks, build_gen_discriminator
...
class GATrainer():
    def __init__(self, input_A, input_B):
        ...
        with fluid.program_guard(self.program):
            self.fake_B = build_generator_resnet_blocks(input_A, name="g_A")
            self.fake_A = build_generator_resnet_blocks(input_B, name="g_B")
            self.cyc_A = build_generator_resnet_blocks(self.fake_B, "g_B")
            self.cyc_B = build_generator_resnet_blocks(self.fake_A, "g_A")
