...
A_LIST_FILE = "./data/selfie2anime/trainA.txt"
B_LIST_FILE = "./data/selfie2anime/trainB.txt"
A_TEST_LIST_FILE = "./data/selfie2anime/testA.txt"
B_TEST_LIST_FILE = "./data/selfie2anime/testB.txt"
IMAGES_ROOT = "./data/selfie2anime/"
